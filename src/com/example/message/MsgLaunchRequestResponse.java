...
public class MsgLaunchRequestResponse extends Message {
	public long requestId = 0;
	public int status = 0;
	
	public MsgLaunchRequestResponse()
    {
        head = new MessageHead();
        head.type = MessageType.ACK_Launch_OK;
        head.id = 0;
        head.nodeID = 0;
    }
	
    public MsgLaunchRequestResponse(long _id, int _nodeID, long _requestId, int _status)
    {
        head = new MessageHead();
        head.type = MessageType.ACK_Launch_OK;
        head.id = _id;
