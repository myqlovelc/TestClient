...
public class MsgStatusPlaying extends Message {
	public long video = 0;
    ...
    public MsgStatusPlaying()
    {
        head = new MessageHead();
        head.id = 0;
        head.nodeID = 0;
        head.type = MessageType.STATUS_Playing;
    }

    public MsgStatusPlaying(long id, int nodeID, String _video_name, long _total_frame, long _current_frame)
    {
        head = new MessageHead();
        head.id = id;
        head.nodeID = nodeID;
