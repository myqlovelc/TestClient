...
public class MsgPauseRequestResponse extends Message {
	...
	public MsgPauseRequestResponse()
    {
        head = new MessageHead();
        head.type = MessageType.ACK_Pause_OK;
        head.id = 0;
        head.nodeID = 0;
    }
	
    public MsgPauseRequestResponse(long _id, int _nodeID, long _requestId, int _status)
    {
        head = new MessageHead();
        head.type = MessageType.ACK_Pause_OK;
        head.id = _id;
