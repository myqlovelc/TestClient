...
public class MsgStopRequestResponse extends Message {
    ...
    public int status = MsgStopRequestResponse.OK;
	
	public MsgStopRequestResponse()
    {
        head = new MessageHead();
        head.type = MessageType.ACK_Stop_OK;
        head.id = 0;
        head.nodeID = 0;
    }
	
    public MsgStopRequestResponse(long _id, int _nodeID, long _requestId, int _status)
    {
        head = new MessageHead();
        head.type = MessageType.ACK_Stop_OK;
        head.id = _id;
