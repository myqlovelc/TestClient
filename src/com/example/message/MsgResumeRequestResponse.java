...
public class MsgResumeRequestResponse extends Message {
	...
	public MsgResumeRequestResponse()
    {
        head = new MessageHead();
        head.type = MessageType.ACK_Resume_OK;
        head.id = 0;
        head.nodeID = 0;
    }
	
    public MsgResumeRequestResponse(long _id, int _nodeID, long _requestId, int _status)
    {
        head = new MessageHead();
        head.type = MessageType.ACK_Resume_OK;
        head.id = _id;
